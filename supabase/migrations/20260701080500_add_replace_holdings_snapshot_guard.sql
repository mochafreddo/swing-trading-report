drop function if exists public.replace_holdings_v1(jsonb);
...
begin
  ...
  if p_expected_holdings is not null then
    ...
    if exists (
      ...
      raise exception using
        ...
        hint = 'Refetch holdings and rebuild the replace snapshot before retrying.';
    end if;
  end if;
