...
const publicEnvelopeMetadataV0Schema = z
  .object({
    ...
    gate_manifest_sha256: hashV0Schema.optional(),
    provider_finnhub_attempts: z.number().int().nonnegative().optional(),
    provider_finnhub_failures: z.number().int().nonnegative().optional(),
    provider_finnhub_timeouts: z.number().int().nonnegative().optional(),
    provider_polygon_news_attempts: z.number().int().nonnegative().optional(),
    provider_polygon_news_failures: z.number().int().nonnegative().optional(),
    provider_polygon_news_timeouts: z.number().int().nonnegative().optional(),
    provider_benzinga_news_attempts: z.number().int().nonnegative().optional(),
    provider_benzinga_news_failures: z.number().int().nonnegative().optional(),
    provider_benzinga_news_timeouts: z.number().int().nonnegative().optional(),
